...
/**
 * Animações do Mutant exportadas do BlockBench.
 * Nomes "atack 1 open" / "atack 1 close" do export original foram convertidos
 * para identificadores Java válidos: atack_1_open / atack_1_close.
 *
 * Client-only: AnimationDefinition/Channel/KeyframeAnimations pertencem a
 * net.minecraft.client.animation. Por isso esta classe vive em client.*.
 */
public class MutantAnimations {
    ...
    public static final AnimationDefinition atack_1_open = AnimationDefinition.Builder.withLength(3.0F)
        .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition atack_1_close = AnimationDefinition.Builder.withLength(2.0F)
        .addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
            new Keyframe(0.0F, KeyframeAnimations.degreeVec(-90.0F, 37.5F, 0.0F), AnimationChannel.Interpolations.LINEAR),
