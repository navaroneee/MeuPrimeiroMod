    ...
    public static final RegistryObject<CreativeModeTab> MEU_PRIMEIRO_MOD_TAB = CREATIVE_MODE_TABS.register("meuprimeiromod_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(ModItems.SHAPE.get());
                        output.accept(ModBlocks.PORTAL_CREATOR.get());
                        output.accept(ModBlocks.ENGINEERING_FRAME.get());
                        output.accept(ModBlocks.PORTAL_ENERGY_PORT.get());
                        output.accept(ModBlocks.PORTAL_ITEM_PORT.get());
                        output.accept(ModBlocks.CREATIVE_ENERGY.get());
